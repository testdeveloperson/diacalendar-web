    ...
    <div>
      ...
      {deleteTarget && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-sm w-full p-6 shadow-2xl animate-slideUp">
            <p className="text-gray-700 dark:text-gray-300 mb-6">게시글을 삭제하시겠습니까?</p>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-gray-400 dark:text-gray-500 font-medium">작성한 글이 없습니다</p>
        </div>
      ) : (
        <div className="space-y-3">
          {posts.map(post => (
            <div key={post.id} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200/80 dark:border-white/10 p-4 sm:p-5 hover:shadow-sm transition-shadow">
