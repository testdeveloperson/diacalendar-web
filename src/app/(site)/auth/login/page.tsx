    ...
    <div className="max-w-sm mx-auto mt-10 sm:mt-20">
      <div className="bg-white rounded-2xl border border-gray-200/80 p-6 sm:p-8 shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">커뮤니티에 참여하세요</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100 text-center text-sm space-y-2">
          <p>
            계정이 없으신가요?{' '}
            <Link href="/auth/signup" className="text-blue-600 hover:text-blue-700 font-semibold">회원가입</Link>
          </p>
          <p>
            <Link href="/auth/recover" className="text-gray-400 hover:text-gray-600">비밀번호를 잊으셨나요?</Link>
          </p>
        </div>
      </div>
    </div>
