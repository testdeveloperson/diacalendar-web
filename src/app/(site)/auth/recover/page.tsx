      ...
      <div className="max-w-sm mx-auto mt-10 sm:mt-20">
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-white/10 p-6 sm:p-8 shadow-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">새로운 비밀번호를 입력해주세요</p>
          </div>

          <form onSubmit={handleUpdatePassword} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">새 비밀번호</label>
              <input
                type="password"
                value={newPassword}
      ...
      <div className="max-w-sm mx-auto mt-10 sm:mt-20">
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-white/10 p-6 sm:p-8 shadow-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">이메일 인증</h1>
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">인증번호</label>
              <input
                type="text"
                value={otp}
                ...
                required
                maxLength={6}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white dark:focus:bg-gray-700 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-center text-lg tracking-widest"
                placeholder="000000"
                autoFocus
              />
            </div>
    ...
    <div className="max-w-sm mx-auto mt-10 sm:mt-20">
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-white/10 p-6 sm:p-8 shadow-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">비밀번호 찾기</h1>
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">가입한 이메일로 인증번호를 보내드립니다</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800 text-center text-sm">
          <Link href="/auth/login" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400">로그인으로 돌아가기</Link>
        </div>
      </div>
    </div>
  )
